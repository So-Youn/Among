...
public class SignUp extends AppCompatActivity {
    private static int GOOGLE_LOGIN_OPEN = 101;
    EditText userID;
    EditText name;
    EditText password;
    EditText phone;
    ...
    class HttpInsert extends AsyncTask<MemberDTO, Void, String>{
        ...
        protected String doInBackground(MemberDTO... memberDTOS) {
            ...
            try {
                ...
                url = new URL("http://70.12.224.47:8088/among/member/insert.do");
    ...
    class HttpIDChk extends AsyncTask<MemberDTO, Void, String>{
        ...
        protected String doInBackground(MemberDTO... memberDTOS) {
            ...
            String str="";
            try {
                url = new URL("http://70.12.224.47:8088/among/member/chk.do");
    ...
    public void registerChatEmail(final String userID,String name){
